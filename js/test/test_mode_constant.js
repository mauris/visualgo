...
const MODE_LOGIN = 5;
const MODE_TEST_BEGIN = 6;
const MODE_TEST_SUBMIT = 7;
const MODE_TEST_GET_INFO = 8;
const MODE_TEST_GET_ANSWERS = 9;
const MODE_TEST_GET_STUDENT_ANSWERS = 10;
const MODE_ADMIN = 11;
const MODE_ADMIN_GET_CONFIG = 12;
const MODE_ADMIN_EDIT_CONFIG = 13;
const MODE_ADMIN_RESET_ATTEMPT = 14;
